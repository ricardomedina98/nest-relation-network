...
__decorate([
    typeorm_1.Column({ type: 'timestamp', name: 'created_at' }),
    __metadata("design:type", Date)
], User.prototype, "createdAt", void 0);
__decorate([
    typeorm_1.Column({ type: 'timestamp', name: 'updated_at' }),
    __metadata("design:type", Date)
], User.prototype, "updatedAt", void 0);
__decorate([
    typeorm_1.OneToOne(type => user_details_entity_1.UserDetails, {
        cascade: true,
        nullable: false,
        eager: true,
    }),
    typeorm_1.JoinColumn({ name: 'id_details' }),
