...
export class firstMigration1594013558389 implements MigrationInterface {
    name = 'firstMigration1594013558389'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `users` (`id` int NOT NULL AUTO_INCREMENT, `email` varchar(255) NOT NULL, `username` varchar(255) NOT NULL, `password` varchar(255) NOT NULL, `status` varchar(8) NOT NULL DEFAULT 'ACTIVE', `created_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updated_at` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id_details` int NOT NULL, `id_role` int NOT NULL, UNIQUE INDEX `REL_7780155fc24b5d19a5d1336aca` (`id_details`), UNIQUE INDEX `REL_f8a3754f51a266a160e71d261f` (`id_role`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("DROP INDEX `REL_f8a3754f51a266a160e71d261f` ON `users`");
